...
//
//		// db.selectFromTable(null, args)
//
//		SQLTerm[] arrSQLTerms;
//		arrSQLTerms = new SQLTerm[3];
//		arrSQLTerms[1] = new SQLTerm();
//		arrSQLTerms[1].set_strTableName("students");
//		arrSQLTerms[1].set_strColumnName("first_name");
//		arrSQLTerms[1].set_strOperator("=");
//		arrSQLTerms[1].set_objValue("Noura");
//
//		arrSQLTerms[0] = new SQLTerm();
//		arrSQLTerms[0].set_strTableName("students");
//		arrSQLTerms[0].set_strColumnName("gpa");
//		arrSQLTerms[0].set_strOperator("=");
//		arrSQLTerms[0].set_objValue(new Double(1.2));
//		
//		arrSQLTerms[2] = new SQLTerm();
//		arrSQLTerms[2].set_strTableName("students");
//		arrSQLTerms[2].set_strColumnName("last_name");
//		arrSQLTerms[2].set_strOperator("=");
//		arrSQLTerms[2].set_objValue("Sadek");
//		
...
//	db.insertIntoTable(table, row);
//		row.put("first_name", "Noura");
////		db.updateTable(table, "80-0378", row);
//		db.deleteFromTable(table, row);
	//	db.createIndex("students2", new String[] { "first_name", "last_name", "gpa" });
	
		//db.createIndex("courses", new String[] { "course_id", "course_name", "hours" });
//		
//		  Min: {course_id=gZZ\, course_name=AAAAAA, hours=1}
//		  Max: {course_id=9999, course_name=mzzzzz, hours=12}
	}
}
